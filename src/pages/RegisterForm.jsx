  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://techkruti-backend.onrender.com/api/auth/register",
        formData
      );
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .rf-orb1 {
          ...
          top: -15%; right: -8%; opacity: 0.12;
          animation: rfD1 18s ease-in-out infinite;
        }
        .rf-orb2 {
          width: clamp(200px,40vw,520px); height: clamp(200px,40vw,520px);
          background: radial-gradient(circle, #7c3aed, transparent 70%);
          bottom: -10%; left: -8%; opacity: 0.13;
          animation: rfD2 22s ease-in-out infinite;
        }
        ...
        .rf-card-top {
          ...
          background: linear-gradient(90deg, transparent, #ec4899aa, #a855f7aa, transparent);
        ...
        .rf-title-register {
          display:block;
          background:linear-gradient(135deg,#ec4899 0%,#f97316 55%,#a855f7 100%);
          -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;
        }
        ...
        .rf-alert.success {
          ...
          border:1px solid rgba(16,185,129,0.2); color:#4ade80;
        }
        .rf-alert.error {
        ...
        .rf-btn:hover:not(:disabled) {
          ...
          box-shadow:0 8px 36px rgba(236,72,153,0.5);
        }
        ...
        .rf-login-link a {
          color:rgba(236,72,153,0.7); text-decoration:none;
        ...
        .rf-success-title {
          font-family:'Bebas Neue',sans-serif;
          font-size:clamp(1.5rem,5vw,2.2rem); letter-spacing:0.06em;
          background:linear-gradient(135deg,#4ade80,#06b6d4);
          -webkit-background-clip:text; -webkit-text-fill-color:transparent;
          background-clip:text; margin-bottom:8px;
        }
        .rf-success-sub {
          font-size:clamp(12px,2.4vw,13px); color:rgba(255,255,255,0.28);
          letter-spacing:0.06em; line-height:1.7;
        }
        .rf-success-btn {
          display:inline-flex; align-items:center; gap:8px;
          margin-top:22px; padding:10px 28px; border-radius:100px;
          background:linear-gradient(135deg,#ec4899,#a855f7);
          font-family:'Rajdhani',sans-serif;
